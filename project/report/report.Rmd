...
As anticipated, EFF and salary has a positive correlation (r = 0.474). This is
reasonable as managers of each team will be willing to recruit players based 
on their over all skill levels. However, therefore there are several factors
that weakened the correlation.

The salaries of a player are determined at the beginning of the season. Even
though a player may perform well for several years, 2015-2016 may be one of
worse years. Also, salaries of a player within a team rarely go down. So for
some players who stayed on the same team for a while, they will be paid well
compared to many rookies in the team regardless of his performance during the
2015-2016 season.
